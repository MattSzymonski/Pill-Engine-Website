...
```toml
[build]
rustdocflags = ["--extend-css", "../Pill-Engine-Website/docs/.vitepress/theme/shared.css"]
```
...
- API docs: `cargo doc -p pill_engine --no-deps` in the Rust workspace
>>>>>>> c28f72a13492255a9767b491ed83ca5dbcff050d:docs/README.md
