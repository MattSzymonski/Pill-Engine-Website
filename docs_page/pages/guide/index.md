...
<div class="hero">
  <div class="hero-inner">
    <div class="hero-left">
      <a href="https://pillengine.org"><img src="https://pillengine.org/logos/pill_logo.svg" alt="Pill Engine Logo" class="hero-logo" /></a>
      <p class="tagline">
      ...
      <p class="badges">
        ...
        <img alt="License" src="https://img.shields.io/badge/license-MIT%20%2F%20Apache--2.0-blue?style=flat-square" />
        <img alt="Rust" src="https://img.shields.io/badge/rust-stable-ff7ab6?style=flat-square" />
        <img alt="Pill" src="https://img.shields.io/badge/💊💊💊-blue" />
      </p>
    </div>
  </div>
</div>

Good to see you, here, take this 🫴 💊

## Quick start

<div class="features-grid">
  <div class="feature">
    <a href="/guide/what-is-pill">
      <h3>What is Pill?</h3>
...
<div class="features-grid">
  <div class="feature">
    <h3>🚀 ECS-first</h3>
    <p>Modular entity-component architecture. Fast iteration and cache-friendly data layouts.</p>
  </div>
  <div class="feature">
    <h3>🎮 Renderer</h3>
    <p>Material system, texture support, mesh loading and post-processing.</p>
  </div>
  <div class="feature">
    <h3>⚙️ Physics</h3>
    <p>Rapier-based rigid bodies, colliders, and realistic simulation.</p>
  </div>
  <div class="feature">
    <h3>🌐 Networking</h3>
    <p>Client-server tools and entity synchronization utilities.</p>
  </div>
</div> -->
