        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ clipPath: 'inset(0)' }}>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pointer-events-none">
                <div className="animate-slide-up">
                    ...
                    <h1 className="tracking-tight text-[140px] sm:text-[220px] md:text-[300px] lg:text-[320px] font-semibold mb-8 text-white tracking-tight lowercase drop-shadow-[0_8px_16px_rgba(0,0,0,0.8)]" style={{ fontFamily: '"Chillax Variable", sans-serif' }}>
                    ...
                    <p className="text-xl md:text-4xl text-gray-200 mt-[64px] mb-6 max-w-4xl mx-auto leading-relaxed drop-shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
                        Modern, <span className="text-pill-red font-bold">Free</span> and <span className="text-pill-red font-bold">blazingly fast</span> game engine
                    </p>
