        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ clipPath: 'inset(0)' }}>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pointer-events-none">
                <div className="animate-slide-up">
                    ...
                    <img
                        src="/pill_logo.svg"
                        alt="Pill Engine Logo"
                        className="h-[160px] sm:h-[220px] md:h-[300px] lg:h-[380px] md:mb-8 drop-shadow-glow-md mx-auto"
                    />

                    <p className="text-xl md:text-4xl text-gray-200 mt-[40px] md:mt-[64px] mb-6 max-w-4xl mx-auto leading-relaxed drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)]">
                    ...
                    <p className="hidden md:block text-md md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
                        Because everyone's idea deserves an open source, next generation game engine to bring it to life
                    </p>

                    {/* Enhanced CTA Buttons */}
                    <div className="hidden md:block">
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-16 pointer-events-auto">
                            <a href="/guide" target="_blank" rel="noopener noreferrer"
                                className="group relative w-48 md:w-56 py-3 md:py-5 bg-gradient-to-r from-pill-blue to-pill-blue-light dark:from-pill-red dark:to-pill-red-light rounded-xl md:rounded-2xl font-bold text-white text-lg overflow-hidden transition-all duration-300 hover:scale-110 hover:shadow-glow-md btn-glow text-center">
                                <span className="relative z-10 flex items-center justify-center gap-2 md:gap-3 text-[13px] md:text-lg">
                            ...
                            <a href="https://github.com/MattSzymonski/Pill-Engine" target="_blank" rel="noopener noreferrer"
                                className="group relative w-48 md:w-56 py-3 md:py-5 border-2 border-pill-blue dark:border-pill-red text-pill-blue dark:text-pill-red rounded-xl md:rounded-2xl font-bold text-lg transition-all duration-300 hover:bg-pill-blue dark:hover:bg-pill-red hover:text-white hover:scale-110 hover:shadow-glow-sm overflow-hidden text-center">
                                <span className="relative z-10 text-[13px] md:text-lg white-text-glow">View on GitHub</span>
