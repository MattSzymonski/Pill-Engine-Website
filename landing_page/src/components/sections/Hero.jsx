            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="mb-4 sm:mb-6 animate-fade-in">
                    <img
                        src="/pill_logo.svg"
                        alt="Pill Engine"
                        className="h-[80px] sm:h-[180px] mx-auto"
                    />
                </div>
                ...
                >
                    <a
                        ...
                        className="inline-flex items-center justify-center gap-2.5 w-full sm:w-auto px-8 py-3.5 bg-white text-black font-semibold rounded-xl hover:bg-gray-100 transition-all duration-200 text-base"
                    >
                        <img src="/pill_mark_red.svg" alt="" aria-hidden="true" className="w-5 h-5" />
                        Contact
                    </a>
                    <a
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2.5 w-full sm:w-auto px-8 py-3.5 bg-white/[0.04] border border-white/[0.08] text-white font-semibold rounded-xl hover:bg-white/[0.08] hover:border-white/[0.14] transition-all duration-200 text-base"
                    >
                        <img src="/pill_mark_blue.svg" alt="" aria-hidden="true" className="w-5 h-5" />
                        Blue pill
                    </a>
                </div>
